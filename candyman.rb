...
#User chooses rather or not they want to play or not
case answer
    when options[0]
...
#Comfirmation that the user wants to play
sleep 2
...
#Results of the choice that was made in line 59
...
bit your finger "
    	...
    	puts "The stoner respects your decision and buys all the candy. Congratlations on your first sale!"
    else
...
a simple question she takes your candy"
    ...
    #if the user doesnt select any of the 3 options above
else
    puts "Since you don't know how to answer the question your candy plug drives by and takes all of your candy. Now you can't sell candy. Congratlations, you played yourself"
end